jQuery(function($) {
	...
	if (($.browser.msie) &&
		($.browser.version <= 8))
	{
		$('#locationCheckBoxList-furnishing ul li:first-child').addClass(
			'last');

		$('#locationCheckBoxList-furnishing ul li:last-child').addClass(
			'last');
	}

	$('#locationCheckBoxList-furnishing .checkBoxList_list input.checkBoxList_item.specialInternationRegions').parent('li').addClass(
	...
	var CoBrandStateSelection = (function ()
	{
				...
				if (selectedStates.length > 2)
				{
					...
					if ((selectedStates.length % 2) == 0)
					{
						for (var index = 0; index < selectedStates.length; index += 2)
						{
							...
							var chkSelectedState = $('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][value=' + selectedStateAbbreviation + ']');
						...
						var totallocationCheckboxCount = $('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][name=location]').length;
						var totallocationCheckedCount = $('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][name=location]:checked').length;
					...
					(selectedStates != 'XX'))
				{
					var chkSelectedState = $('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][value=' + selectedStates + ']');
		...
		{
			$('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox]').attr(
				'checked',
				false);
		...
		coBrandStateSelection.HideStateSelection = function ()
		{
			...
			$('#locationCheckBoxList-furnishing').hide();
		};
		...
		$('.locationCheckBoxList-furnishing').click(function (event){
                    alert('asd');
			...
			event)
		{
			...
			var stateCheckBoxList = $('#locationCheckBoxList-furnishing');
		...
		{
			$('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][name=location]').attr(
				'checked',
				this.checked);
		});

		$('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox]').click(function ()
		{
			if (this.checked)
			{
				var totalCheckboxCount = $('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][name=location]').length;
				var totalCheckedCount = $('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][name=location]:checked').length;
		...
		$('#hlOKLocationSelection').click(function ()
		{
			...
			if (hidSelectedLocation.length > 0)
			{
				...
				else
				{
					...
					var chkSelectedStates = $('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox]:checked');
					...
					(chkAllLocation.length > 0))
				{
					...
					var chkSelectedInternationalRegions =
						$('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][name=specialInternationalRegion]:checked');
					...
					if (chkSelectedInternationalRegions.length > 0)
					{
						...
						if (selectedAbbreviations.length > 0)
						{
							...
							var chklocations =
								$('#locationCheckBoxList-furnishing .checkBoxList_list input[type=checkbox][name=location]');
