...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <h2>Are you a landlord  of the OneHome Property? Please enter your FIN/NRIC and password below and Click login button. </h2>
    ...
    <div class="in-row clearfix">
        ...
        <div class="group-1">
            <div class="f-left">
                ...
                <p class="space-4"><a href="<?php echo Yii::app()->createAbsoluteUrl('site/landlord_forgot_password') ?>">Forgot your password?</a></p>
            </div>
