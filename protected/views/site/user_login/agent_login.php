...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    <div class="clearfix">
        <h2>Are you an agent of the OneHome Property? Please enter your FIN/NRIC and password below and Click login button. </h2>
    ...
    <div class="in-row clearfix">
        ...
        <div class="group-1">
            <div class="f-left">
                ...
                <p class="space-4"><a href="<?php echo Yii::app()->createAbsoluteUrl('site/agent_forgot_password') ?>">Forgot your password?</a></p>
            </div>
