...
//        self::_setTestEmail($data, 'quocbao1087@gmail.com');
    ...
    {
		$modelEmailTemplate = is_int($iEmailTemplateID) ? 
			EmailTemplates::model()->findByPk($iEmailTemplateID) :
			EmailTemplates::model()->findByAttributes(array('slug'=>$iEmailTemplateID));
        ...
        $data = array(
            ...
            'view'=>'message',
            'to'=>$sTo,
            'from'=>empty($sFrom)? Yii::app()->params['autoEmail']:$sFrom,
        );
