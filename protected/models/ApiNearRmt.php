...
/**
 * This is the model class for table "{{_api_near_rmt}}".
 *
 * The followings are the available columns in table '{{_api_near_rmt}}':
 * @property integer $id
 ...
 */
class ApiNearRmt extends CActiveRecord
{
	/**
	 ...
	 * @return ApiNearRmt the static model class
	 */
