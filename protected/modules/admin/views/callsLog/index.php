...
//        array('label'=> Yii::t('translation', 'Tenancies Management'), 'url'=>array('tenancies')),
	array('label'=> 'Create Calls Log', 'url'=>array('create', 'id'=>$model->transaction_id), 'moreClass'=>'createCallsLog'),
);
...
function fnUpdateColorbox(){    
    ...
    $(".update").colorbox({iframe:true,innerHeight:'500', innerWidth: '800',close: "<span title='close'>close</span>",overlayClose :false, escKey:false});
}
</script>