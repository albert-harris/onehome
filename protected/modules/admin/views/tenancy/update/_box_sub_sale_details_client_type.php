...
<div class="wrap_client_type_info display_none wrap_commission">
    <div class="in-row clearfix bill_to_company_name display_none">
        <?php if( !$mTransactions->mBillTo->getError('company_name')): ?>
            <?php echo $form->labelEx($mTransactions->mBillTo,'company_name', array('class'=>'lb', 'label'=>$mTransactions->mBillTo->getAttributeLabel('company_name').'<span class="required"> *</span>')); ?>
        <?php else:?>
    ...
    <div class="in-row clearfix">
        ...
        <div class="group-4">
            <input class="text commission_amount_gst_show" value="<?php echo $cmsFormater->formatPrice($mTransactions->mBillTo->commission_amount_gst);?>" readonly="1" type="text" >
            <?php // echo $form->textField($mTransactions->mBillTo,'commission_amount_gst',array('class'=>'text commission_amount_gst', 'readonly'=>1)); ?>
            <?php echo $form->hiddenField($mTransactions->mBillTo,'commission_amount_gst',array('class'=>'text commission_amount_gst', 'readonly'=>1)); ?>
