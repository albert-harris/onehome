...
<?php if(isset($_GET['add_property']) ):?>
    <div class="in-row clearfix">
        <?php 
            ...
            $urlForExisting = Yii::app()->createAbsoluteUrl('admin/tenancy/createTenancy',array(
            ...
            $urlForUnlisted = Yii::app()->createAbsoluteUrl('admin/tenancy/createTenancy',array(
...
<script>
    ...
    function fnBuildRowItem(event, ui){
        ...
        ?>
        var requestUri = '<?php echo Yii::app()->createAbsoluteUrl('admin/tenancy/createTenancy',array('add_property'=>$add_property,'id'=>$id, 'type'=>$type, 'user_id'=> $mTransactions->user_id));?>/listing_id/'+ui.item.id;
