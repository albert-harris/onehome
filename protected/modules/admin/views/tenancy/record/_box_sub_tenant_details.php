...
//                        if( (!$mTransactions->mTenatDefault->isNewRecord && $mTransactions->mTenatDefault->scanned_employment_pass!='') || !empty($scanned_employment_pass)){
                    ...
                    <p class="<?php echo $display;?> p_scanned_employment_pass clr" style="text-align: left;">
                        Current File: <span class="span_scanned_employment_pass">
                            <?php // echo $mTransactions->mTenatDefault->scanned_employment_pass;?>
...
//                    if( ( !$mTransactions->mTenatDefault->isNewRecord && $mTransactions->mTenatDefault->scanned_passport) || !empty($scanned_passport)){
                    ...
                    <p class="<?php echo $display;?> p_scanned_passport clr" style="text-align: left;">
                        ...
                        <span class="span_scanned_passport"> 
                            <?php // echo $mTransactions->mTenatDefault->scanned_passport;?>
    ...
    <div class="title clearfix">
        ...
        <!-- ANH DUNG CLOSE MAY 06, 2015, REMOVE BIEN from_transactions VI LIEN QUAN DEN VALIDATE <a data-fancybox-type="iframe" href="<?php echo Yii::app()->createAbsoluteUrl('ajax/agentAddTenant', array('transactions_id'=>$mTransactions->id, "from_transactions"=>1, 'listing_id'=>(isset($_GET['listing_id'])?$_GET['listing_id']:''), "add_property"=> $mTransactions->add_property  )); ?>" class="btn-1 f-right TenantDetails">Add More Tenant</a>-->
        <a data-fancybox-type="iframe" href="<?php echo Yii::app()->createAbsoluteUrl('ajax/agentAddTenant', array('transactions_id'=>$mTransactions->id, 'listing_id'=>(isset($_GET['listing_id'])?$_GET['listing_id']:''), "add_property"=> $mTransactions->add_property  )); ?>" class="btn-1 f-right TenantDetails">Add More Tenant</a>
    </div>
...
//            $('#ProTransactionsVendorPurchaserDetail_id_type').trigger('change');
        ...
        /* ANH DUNG close May 06, 2015 */
        $('#ProTransactionsVendorPurchaserDetail_id_type').change(function(){
            // ANH DUNG May 06, 2015
            <?php if( $mTransactions->mTenatDefault->scenario == 'AgentAddTenantFromTenancy' 
                || $mTransactions->mTenatDefault->scenario == 'AgentUpdateTenantFromTenancy'
                ): ?>
                //return ;
            <?php endif;?>
            // ANH DUNG May 06, 2015
        ...
        <?php // if($mTransactions->mTenatDefault->id_type != '' &&  ( $mTransactions->mTenatDefault->id_type != Users::ID_TYPE_CITIZENSHIP || $mTransactions->mTenatDefault->id_type != Users::ID_TYPE_SPR) ):?>
//            $('#ProTransactionsVendorPurchaserDetail_id_type').trigger('change');
        <?php // endif;?>            
