...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo Yii::t('translation', $form->labelEx($model,'is_admin_created')); ?>
		<?php echo $form->textField($model,'is_admin_created'); ?>
		<?php echo $form->error($model,'is_admin_created'); ?>
	</div>

	<div class="row">
		<?php echo Yii::t('translation', $form->labelEx($model,'created_by')); ?>
		<?php echo $form->textField($model,'created_by',array('size'=>11,'maxlength'=>11)); ?>
		<?php echo $form->error($model,'created_by'); ?>
	</div>

	<div class="row">
		<?php echo Yii::t('translation', $form->labelEx($model,'add_property')); ?>
		<?php echo $form->textField($model,'add_property'); ?>
		<?php echo $form->error($model,'add_property'); ?>
	</div>
	...
	<div class="row">
		<?php echo Yii::t('translation', $form->labelEx($model,'admin_approved')); ?>
