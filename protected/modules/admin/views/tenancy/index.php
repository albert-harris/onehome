        ...
        'afterAjaxUpdate'=>'function(id, data){ fixTargetBlank(); fnUpdateLink(); }',
          'columns'=>array(
            array(
                ...
                'name' => 'sPropertyName',
                'type' =>'propertyname',
                'value' => 'array("name"=>$data->listing?$data->listing->property_name_or_address:"", "transaction_id"=>$data->id,"orther"=>isset($data->listing) ? $data->listing->property_house_blk_no:"","title_full"=>$data )',//$data->listing->property_name_or_address'
...
//                'header' => 'Expiring Date',
            ...
            array(
                ...
                'visible'=> MyFormat::isAllowAccess("callsLog", "index") ,
            ),
            array(
                ...
                'value'=>'$data',
                'htmlOptions' => array('style' => 'text-align:center;'),
                'visible'=> MyFormat::isAllowAccess("reportDefect", "index") ,
            ),
            array(
                ...
                'value'=>'$data',
                'htmlOptions' => array('style' => 'text-align:center;'),
                'visible'=> MyFormat::isAllowAccess("tenancy", "inventoryPhoto") ,
            ),
            array(
                ...
                'value'=>'$data',
                'htmlOptions' => array('style' => 'text-align:center;'),
                'visible'=> MyFormat::isAllowAccess("airconService", "index") ,
            ),
            ...
            array(
                ...
                'buttons'=>array(
                    'update'=>array(
                        ...
                        'url'=>'ProTransactions::GetLinkUpdateTenancyBE($data, array("update_tenancy_approved"=>1))',
