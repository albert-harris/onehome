        ...
        'afterAjaxUpdate'=>'function(id, data){ fixTargetBlank(); fnUpdateLink(); }',
          'columns'=>array(
            array(
                ...
                'name' => 'sPropertyName',
                'type' =>'propertyname',
                'value' => '$data->listing ? array("name"=>$data->listing->property_name_or_address, "transaction_id"=>$data->id,"title_full"=>$data): ""',//$data->listing->property_name_or_address'
...
//            ),
            ...
            array(
                'header' => 'Actions',
                'class'=>'CButtonColumn',
                'template'=> ControllerActionsName::createIndexButtonRoles($actions, array('CreateTenancy', 'delete')),
                'buttons'=>array(
                    'CreateTenancy'=>array(
