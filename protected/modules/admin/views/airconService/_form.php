...
//                        'maxDate'=> '0',
    ...
    <div class="row">
        <?php echo $form->labelEx($model,'upload_service_documents', array('class'=>' w-200')); ?>
        <?php echo $form->fileField($model,'upload_service_documents'); ?>
            <br>
            <span>Only <?php echo ProAirconService::$AllowFile ;?> is allow</span>
            <?php if( !$model->isNewRecord && trim($model->upload_service_documents)!='' ): ?>
            <br>
            <span><label class='w-200'>Current file:</label> <?php echo $model->upload_service_documents;?></span>
            <?php endif;?>
            
        <?php echo $form->error($model,'upload_service_documents'); ?>
    </div>
    <div class="row">
        <?php echo $form->labelEx($model,'remark', array('class'=>' w-200')); ?>
        <?php echo $form->textarea($model,'remark',array('rows'=>5)); ?>
