...
<tr style="font-size: 12px;">
    ...
    <td class="last"><a class="btn-2 remove-file-doc" rel="<?php echo Yii::app()->createAbsoluteUrl('admin/listing/ajaxdelete_doc',array('listing'=>$data->listing_id,'doc'=>$data->id)) ?>"  href="javascript:;">Remove</a></td>
</tr>