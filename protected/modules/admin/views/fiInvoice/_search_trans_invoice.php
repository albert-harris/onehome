...
//ProTransactionsInvoice::updateAllTransInvoice();
$cAction = strtolower(Yii::app()->controller->action->id);
?>

	<div class="row">
		<?php echo $form->label($model,'invoice_number', array('label'=>'Invoice No')); ?>
		<?php echo $form->textField($model,'invoice_number',array('size'=>30,'maxlength'=>30)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'property_address',array('size'=>30,'maxlength'=>300)); ?>
	</div>
