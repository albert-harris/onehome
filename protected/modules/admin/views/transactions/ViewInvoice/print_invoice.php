...
$headTitle = "View Invoice $model->invoice_number";

if(!isset($_GET['from_trans_invoice'])){
    if($model->invoice_type == ProTransactionsInvoice::TYPE_RECEIPT){
        $headText = 'Transactions Management';
        $headLink = array('index');
        $headLinkBreck = array('index');
        $headTitle = "View Receipt $model->invoice_number";
...
<div id="printElement">
    <?php include "invoice_$template.php"; ?>
</div>
