<div class="in-row clearfix">
    ...
    <div class="group-4">
        <?php echo $form->textField($mTransactions->mPropertyDetail,'property_name_or_address',array('class'=>'w-200 anhdung_fix_enter text f-left ad_property_name_or_address', 'placeholder'=>'Type Listing name to search', 'style'=>'')); ?>
