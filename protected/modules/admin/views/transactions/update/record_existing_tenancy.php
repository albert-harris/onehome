...
$this->breadcrumbs=array(
	Yii::t('translation','Transactions Management')=>array('index'),
	Yii::t('translation','Update Transaction'),
);

$menus = array(		
        array('label'=> Yii::t('translation', 'Transactions Management') , 'url'=>array('index')),
);
...
<?php if(isset($_GET['user_id'])):  $sUidGst = $_GET['user_id']; ?>
    <div class="need_select_saleperson">
        ...
        <div class="clearfix output">
            <a href="<?php echo $this->createUrl('index');?>" class="btn-3">Cancel</a>            
