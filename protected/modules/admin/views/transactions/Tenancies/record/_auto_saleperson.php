...
function fnBuildTrInfoTier(item, idField){    
    var user_id = item.id;
    var url_ = '<?php echo Yii::app()->createAbsoluteUrl('admin/transactions/createTenancy/', array('add_property'=> (isset($_GET['add_property'])?$_GET['add_property']:1 ) )) ;?>/user_id/'+user_id;
