...
<?php if(isset($_GET['add_property']) ):?>
    <div class="in-row clearfix">
        <?php 
            ...
            $urlForExisting = Yii::app()->createAbsoluteUrl('admin/transactions/createTenancy',array(
            ...
            $urlForUnlisted = Yii::app()->createAbsoluteUrl('admin/transactions/createTenancy',array(
    ...
    <div class="in-row clearfix">
        ...
        <div class="group-4">
            ...
            <?php echo $form->textField($mTransactions,'listing_autocompelte',array('class'=>'text listing_autocomplete f-left w-250','readonly'=>$readonly_auto, 'placeholder'=>'Type Listing name to search', 'style'=>'width:251px;')); ?>
...
<script>
    $(function(){
        ...
        $( ".listing_autocomplete" ).autocomplete({
            source: '<?php echo Yii::app()->createAbsoluteUrl('ajax/searchListing', array('from_be_uid'=>$mTransactions->user_id));?>',
    ...
    function fnBuildRowItem(event, ui){
        ...
        ?>
        var requestUri = '<?php echo Yii::app()->createAbsoluteUrl('admin/transactions/createTenancy',array('add_property'=>$add_property,'id'=>$id, 'type'=>$type, 'user_id'=> $mTransactions->user_id));?>/listing_id/'+ui.item.id;
