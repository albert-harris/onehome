...
class ContactusController extends AdminController
{
    ...
    public function actionView($id) {
        try {
            $this->render('view', array('model' => $this->loadModel($id), 'actions' => $this->listActionsCanAccess,));
        }
        catch(Exception $e) {
        ...
        try {
            if (Yii::app()->request->isPostRequest) {
                ...
                if ($model = $this->loadModel($id)) {
                    if ($model->delete()) Yii::log("Delete record " . print_r($model->attributes, true), 'info');
                }
    ...
    public function actionIndex() {
        try {
            $model = new ProContactUs('search');
            $model->unsetAttributes();
             // clear any default values
            if (isset($_GET['ProContactUs'])) $model->attributes = $_GET['ProContactUs'];
    ...
    protected function performAjaxValidation($model) {
        try {
            if (isset($_POST['ajax']) && $_POST['ajax'] === 'pro-contact-us-form') {
