...
class TransactionsVoucherController extends AdminController
{
    /**
     ...
     * Manages all models.
     */
    public function actionIndex($transactions_id)
    {
        try
        {
        $model=new ProTransactionsInvoice('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['ProTransactionsInvoice']))
            $model->attributes=$_GET['ProTransactionsInvoice'];

        $model->transactions_id = $transactions_id;
    ...
    protected function performAjaxValidation($model)
    {
            try
            {
            if(isset($_POST['ajax']) && $_POST['ajax']==='pro-transactions-invoice-form')
            {
