...
class ProuploaddocumentController extends AdminController
{
	/**
	...
	public function actionCreate() {
        try {
            $model = new ProUploadDocument('create');
	...
	public function actionIndex()
	{
                try
                {
		$model=new ProUploadDocument('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProUploadDocument']))
			$model->attributes=$_GET['ProUploadDocument'];
	...
	public function loadModel($id)
	{
                try
                {
		$model=ProUploadDocument::model()->findByPk($id);
		if($model===null)
                {
	...
	protected function performAjaxValidation($model)
	{
                try
                {
		if(isset($_POST['ajax']) && $_POST['ajax']==='pro-upload-document-form')
		{
