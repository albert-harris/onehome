<div class="fix_table_grid">
    ...
    <a data-fancybox-type="iframe" href="<?php echo Yii::app()->createAbsoluteUrl('ajax/addAirconService', array('transaction_id'=>$_GET['transaction_id'])); ?>" class="btn-5 add_report_item"> Schedule </a>
    </div>
...
//                                'imageUrl'=>Yii::app()->theme->baseUrl . '/img/gridview/update.png',
                                'options'=>array('class'=>'update_item btn-5', 'data-fancybox-type'=>'iframe'),
