    ...
    <div class="form-type content">
        <div class="in-row clearfix">
            <div class="">
                ...
                <div class="in-row clearfix">
                    <?php echo $form->labelEx($model, 'ic_number', array('class'=>'lb')); ?>
                    <div class="group-4">
                        <?php echo $form->textField($model,'ic_number',array('class'=>'text w-0','maxlength'=>100, 'placeHolder'=>'')); ?>
                ...
                <div class="in-row clearfix pass_expiry_date">
                    ...
                    <div class="group-4">
                        ...
                        $this->widget('zii.widgets.jui.CJuiDatePicker', array(
                            ...
                            'htmlOptions'=>array(
                                'class'=>'w-16',
                                'style'=>'height:20px;width:245px;margin-left:3px;',//width:166px
//                                'readonly'=>'readonly',
                            ),
                        ));
                        ?>
                ...
                <div class="in-row clearfix scanned_employment_pass">
                    ...
                    <div class="group-upload f-left w-400">
                        ...
                        <span><br>Only <?php echo Users::$AllowFile ;?> are allow</span>
                        <?php                         
                        $file = ROOT."/".Users::$folderUpload."/"."$model->id/".$model->upload_employment_pass_passport;
                        if(!$model->isNewRecord && $model->upload_employment_pass_passport && file_exists($file) ):
                            $res='';
...
<!--                            <p style="text-align: left;padding-left: 222px;">
                ...
                <div class="in-row clearfix scanned_passport">
                    ...
                    <div class="group-upload f-left w-400">
                        ...
                        if(!$model->isNewRecord && $model->scanned_passport && file_exists($file)):
                            $res='';                            
