...
<!--<a data-fancybox-type="iframe" href="<?php // echo Yii::app()->createAbsoluteUrl('member/tenant/uploadfile', array('transaction_id'=>$_GET['transaction_id'])); ?>" class="btn-5 upload_item"> Add More </a>-->
                ...
                array(
                    ...
                    'buttons'=>array(
                        ...
                        (
                            ...
                            'visible' => '$data->user->role_id == ROLE_TENANT'
                        ),                        
                    ),
                )
	),
