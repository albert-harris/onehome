...
<?php 
// xử lý sau ?????
    $backUrl = Yii::app()->createAbsoluteUrl('member/listing');
    $backText = 'Listing Management';
...
<div class="breadcrumb">
    ...
    &raquo; <strong>View Transaction</strong></div>
...
<?php echo MyFormat::BindNotifyMessage();?>
...
<h1 class="title-page">VIEW TRANSACTION <?php echo $type_for_text;?> : <?php echo $mTransactions->transactions_no;?></h1>
