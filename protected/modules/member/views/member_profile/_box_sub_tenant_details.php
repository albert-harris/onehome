        ...
        <div class="form-type content">
            ...
            <div class="in-row clearfix">
                ...
                <div class="group-4">
                    ...
                    <?php echo $form->dropDownList($mTransactions->mTenatDefault,'id_type', Users::$TENANT_ID_TYPES, array('empty'=>'Select', 'class'=>'text')); ?>
...
//                                    'readonly'=>'readonly',
            ...
            <div class="in-row clearfix scanned_employment_pass">
                ...
                <div class="group-4">
                    ...
                    <?php $display = 'display_none'; 
                        if(!$mTransactions->mTenatDefault->isNewRecord && $mTransactions->mTenatDefault->scanned_employment_pass!=''){
                            $display = ''; 
                        }
                    ?>                    
            ...
            <div class="in-row clearfix scanned_passport">
                ...
                <div class="group-4">
                    ...
                    <?php $display = 'display_none'; 
                    if(!$mTransactions->mTenatDefault->isNewRecord && $mTransactions->mTenatDefault->scanned_passport){
                        $display = ''; 
                    }
                    ?>
