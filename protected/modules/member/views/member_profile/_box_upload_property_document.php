...
//                        parent_form.submit();
    ...
    /*function fnDisableFileDocument(name_class_allow){
        parent_form = $('.custom-file-upload').closest('form');
        parent_form.find('input:file').each(function(){
            if($(this).attr('id')!=name_class_allow){
                $(this).prop('disabled', true);
            }
        });
    }

    function fnEnableFileDocument(){
        parent_form = $('.custom-file-upload').closest('form');
        parent_form.find('input:file').each(function(){
