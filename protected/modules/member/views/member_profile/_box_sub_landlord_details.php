<div class="box-5">
    <div class="title clearfix">
        ...
        <a data-fancybox-type="iframe" href="<?php echo Yii::app()->createAbsoluteUrl('ajax/agentAddLandlord', array('transactions_id'=>$mTransactions->id, "from_transactions"=> 1, "add_property"=> $mTransactions->add_property )); ?>" class="btn-1 f-right AddVendorDetails">Add Landlord</a>
    </div>
                    ...
                    array(
                        ...
                        'buttons'=>array(
                            'update_item'=>array(
                                ...
                                'url'=>'Yii::app()->createAbsoluteUrl("ajax/agentUpdateLandlord",
                                    array("id"=>$data->id, "from_transactions"=>1,
