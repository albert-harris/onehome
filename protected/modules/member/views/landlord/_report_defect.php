...
//                    'type'=>'Photo',
                ...
                array(
                    'header' => 'Actions',
                    'class'=>'CButtonColumn',
                    'template'=> '{UpdateDefectStatus}{delete_item}',
...
//                        'imageUrl'=>Yii::app()->theme->baseUrl . '/admin/images/edit.png',
                        ...
                        'options'=>array('class'=>'update UpdateDefectStatus', 'data-fancybox-type'=>'iframe'),
                        'url'=>'Yii::app()->createAbsoluteUrl("member/landlord/UpdateDefectStatus",
                            array("id"=>$data->id))',
